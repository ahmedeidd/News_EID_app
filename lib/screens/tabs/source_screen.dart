...
import 'package:flutter_news_json/bloc/get_sources_bloc.dart';
...
import 'package:flutter_news_json/screens/source_detail.dart';
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: ()
              {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => SourceDetail(source: sources[index],),),
                );
              },
              child: Container(
                width: 100.0,
